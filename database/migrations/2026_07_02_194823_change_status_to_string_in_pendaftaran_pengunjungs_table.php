...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Update data lama 'approved' -> 'disetujui' dan 'rejected' -> 'ditolak'
        try {
