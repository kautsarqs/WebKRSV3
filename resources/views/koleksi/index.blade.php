                        ...
                        <div class="relative overflow-hidden aspect-[4/3] bg-zinc-50 border-b border-zinc-100">
                            ...
                            @else
                                <div class="h-full w-full bg-emerald-50/20 flex flex-col items-center justify-center p-6 text-zinc-600">
                                    ...
                                    <span class="text-[10px] text-zinc-600 font-space font-bold uppercase tracking-wider">No Photo Available</span>
                                </div>
                            @endif
                            @if ($koleksi->famili)
                        ...
                        <div class="p-6 space-y-3.5">
                            <div class="space-y-1">
                                ...
                                @elseif ($koleksi->famili)
                                    <p class="text-xs text-zinc-600 font-inter font-medium leading-relaxed">
