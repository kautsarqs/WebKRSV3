<x-slot name="sidebar">
    @if(Auth::user()->role === 'admin')
        ...
        <x-ui.nav-link :href="route('admin.pengunjungs.index')" :active="request()->routeIs('admin.pengunjungs.*')">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
            Daftar Pengunjung
        </x-ui.nav-link>

        <x-ui.nav-link :href="route('admin.penelitis.index')" :active="request()->routeIs('admin.penelitis.*')">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
            Daftar Peneliti
        </x-ui.nav-link>
    @else
