            ...
            <div class="lg:col-span-3">
                ...
                <ul class="space-y-4 text-sm text-zinc-500">
                    <li class="flex items-start gap-3">
                        ...
                        <span>Desa Sabung, Kecamatan Subah, Kabupaten Sambas, Kalimantan Barat</span>
                    </li>
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:Sambaskebunraya@gmail.com" class="hover:text-zinc-900 transition">Sambaskebunraya@gmail.com</a>
                    </li>
                    <li class="flex items-center gap-3">
                        ...
                        <a href="https://wa.me/6289510623500" target="_blank" rel="noopener" class="hover:text-zinc-900 transition">+62 895-1062-3500</a>
                    </li>
                </ul>
            </div>
        </div>
