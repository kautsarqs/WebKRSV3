...
@section('title', 'Hubungi Kami - Kebun Raya Sambas')
        ...
        <div class="bg-white border border-zinc-200 p-8 rounded-3xl shadow-xl shadow-zinc-200/50">
            <form action="#" class="space-y-4">
                <div class="space-y-2">
                    ...
                    <input type="text" class="w-full px-4 py-3 bg-zinc-50 border border-zinc-200 rounded-xl focus:ring-2 focus:ring-zinc-900 focus:border-zinc-900 outline-none transition" placeholder="Masukkan nama anda">
                </div>
                <div class="space-y-2">
                    <label class="block text-sm font-bold text-zinc-700 font-heading">Email</label>
                    <input type="email" class="w-full px-4 py-3 bg-zinc-50 border border-zinc-200 rounded-xl focus:ring-2 focus:ring-zinc-900 focus:border-zinc-900 outline-none transition" placeholder="nama@email.com">
                </div>
                <div class="space-y-2">
                    <label class="block text-sm font-bold text-zinc-700 font-heading">Pesan</label>
                    <textarea rows="4" class="w-full px-4 py-3 bg-zinc-50 border border-zinc-200 rounded-xl focus:ring-2 focus:ring-zinc-900 focus:border-zinc-900 outline-none transition" placeholder="Tulis pesan anda disini..."></textarea>
                </div>
