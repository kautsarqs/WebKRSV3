...
@section('title', 'Pendaftaran Peneliti - Kebun Raya Sambas')
...
<div class="max-w-4xl mx-auto px-4 py-12">
    <div class="mb-10 text-center">
        <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-emerald-200 bg-emerald-50 text-xs text-emerald-700 mb-4">
            <span class="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
            Formulir Penelitian Online
        </div>
    ...
    <div class="bg-white rounded-3xl shadow-xl shadow-zinc-200/50 border border-zinc-100 overflow-hidden p-8 text-center">
        <div class="max-w-md mx-auto">
            ...
            <p class="text-zinc-500 mb-6">
                Untuk dapat mengisi formulir peneliti, silakan masuk ke akun Anda terlebih dahulu.
            </p>
    ...
    <div class="bg-amber-50 border border-amber-200 text-amber-900 rounded-3xl p-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <div>
            ...
            <p class="text-xs text-amber-700 mt-1">Silakan verifikasi email Anda terlebih dahulu sebelum mengajukan permohonan penelitian.</p>
        </div>
    ...
    <form id="form-peneliti" action="{{ route('pendaftaran.peneliti.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-zinc-200/50 border border-zinc-100 overflow-hidden">
            ...
            <div class="p-8 space-y-5">
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="judul_penelitian" id="judul_penelitian" value="{{ old('judul_penelitian') }}"
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="bidang_penelitian" id="bidang_penelitian" value="{{ old('bidang_penelitian') }}"
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea name="tujuan_penelitian" id="tujuan_penelitian" rows="5"
                        ...
                        placeholder="Jelaskan tujuan, latar belakang, dan manfaat penelitian Anda..." required>{{ old('tujuan_penelitian') }}</textarea>
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-zinc-200/50 border border-zinc-100 overflow-hidden">
            ...
            <div class="p-8 space-y-6">
                <div class="space-y-2">
                    <label for="surat_izin_meneliti" class="text-sm font-semibold text-zinc-700">Surat Izin Meneliti dari Universitas / Institusi <span class="text-red-500">*</span></label>
                ...
                <div class="space-y-2">
                    <label for="cv" class="text-sm font-semibold text-zinc-700">Curriculum Vitae (CV) <span class="text-red-500">*</span></label>
