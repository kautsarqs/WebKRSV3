...
<head>
    <meta charset="utf-8">
    <title>Penelitian - Kebun Raya Sambas</title>
    ...
    <main class="pt-32 pb-20">
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
                ...
                <a href="/kontak" class="px-6 py-3 bg-zinc-900 text-white rounded-xl font-medium hover:bg-zinc-800 transition">Ajukan Kerjasama</a>
            </div>
