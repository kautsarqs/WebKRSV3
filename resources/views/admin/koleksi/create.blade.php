                ...
                <div class="p-6 border border-zinc-200 rounded-2xl bg-zinc-50/50 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1">
                            ...
                            <input id="kerajaan" type="text" name="kerajaan" value="{{ old('kerajaan') }}" list="list-kerajaan"
                        ...
                        <div class="space-y-1">
                            ...
                            <input id="divisi" type="text" name="divisi" value="{{ old('divisi') }}" list="list-divisi"
                        ...
                        <div class="space-y-1">
                            ...
                            <input id="kelas" type="text" name="kelas" value="{{ old('kelas') }}" list="list-kelas"
                        ...
                        <div class="space-y-1">
                            ...
                            <input id="order" type="text" name="order" value="{{ old('order') }}" list="list-order"
                        ...
                        <div class="space-y-1">
                            ...
                            <input id="famili" type="text" name="famili" value="{{ old('famili') }}" list="list-famili"
                        ...
                        <div class="space-y-1">
                            ...
                            <input id="genus" type="text" name="genus" value="{{ old('genus') }}" list="list-genus"
                        ...
                        <div class="space-y-1">
                            ...
                            <input id="otoritas_1" type="text" name="otoritas_1" value="{{ old('otoritas_1') }}"
                        ...
                        <div class="space-y-1 md:col-span-2">
                            ...
                            <input id="otoritas_2" type="text" name="otoritas_2" value="{{ old('otoritas_2') }}"
