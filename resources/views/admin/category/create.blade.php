<x-dashboard-layout title="Tambah Kategori Baru">
    <x-admin-sidebar />
    ...
    <div class="max-w-2xl mx-auto py-6">
        ...
        <div class="relative bg-white/60 backdrop-blur-xl border border-zinc-200/60 rounded-3xl shadow-xl shadow-zinc-200/40 p-8">
            ...
            <div class="space-y-1 mb-8">
                <h3 class="text-2xl font-bold font-space text-zinc-900 tracking-tight">Tambah Kategori Baru</h3>
                <p class="text-zinc-500 text-sm font-inter">Isi formulir berikut untuk menambahkan kategori baru.</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.categories.store') }}" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus 
                        class="w-full px-4 py-3 bg-white/50 border border-zinc-300 rounded-xl focus:ring-2 focus:ring-zinc-900 focus:border-zinc-900 transition-all outline-none text-zinc-800 shadow-sm placeholder-zinc-400" placeholder="Contoh: Anggrek" />
