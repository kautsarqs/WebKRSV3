<x-app-layout>
    <div class="min-h-screen flex items-center justify-center bg-zinc-50 relative overflow-hidden font-inter selection:bg-zinc-900 selection:text-white">
        
        <div class="relative w-full max-w-md p-6">
            
            <div class="text-center mb-10">
                <h1 class="text-4xl font-bold tracking-tight font-space text-zinc-900">Login</h1>
                <p class="text-zinc-500 mt-2 text-base">Masuk ke akun Kebun Raya Sambas</p>
            </div>
            ...
            <form method="POST" action="{{ route('login.store') }}" class="space-y-6">
                ...
                <button type="submit" 
                    class="w-full py-4 px-4 bg-zinc-900 hover:bg-zinc-800 text-white font-bold rounded-2xl transition-all transform hover:scale-[1.01] active:scale-[0.99] font-space shadow-xl shadow-zinc-900/10">
                    Masuk
                </button>
            </form>
            ...
            <div class="text-center text-sm text-zinc-500">
                Belum punya akun? <a href="{{ route('register') }}" class="font-bold text-zinc-900 hover:underline font-space decoration-2 underline-offset-4">Daftar sekarang</a>
            </div>
        </div>
    </div>
</x-app-layout>